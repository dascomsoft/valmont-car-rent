...
export const reservations = sqliteTable('reservations', {
  ...
  // Statut de la réservation
  status: text('status').default('pending'), // pending, pending_payment, confirmed, in_progress, completed, cancelled, expired
  ...
  // Date d'expiration pour les réservations pending (15 minutes)
