...
import { getFeaturedVehicles } from '@/lib/actions.js';
import VehicleCardSimple from '@/components/VehicleCardSimple.jsx';  // ← NOUVEAU COMPOSANT
import HeroSection from '@/components/HeroSection.jsx';
import { Suspense } from 'react';
import { FaShieldAlt, FaMoneyBillWave, FaTruck, FaHeadset, FaStar, FaMapMarkerAlt, FaCalendarAlt, FaClock } from 'react-icons/fa';

// Section véhicules vedettes (version simple sans boutons)
async function FeaturedVehicles() {
  const vehicles = await getFeaturedVehicles();
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div>
          ...
          <input
            ...
            required
            placeholder="Aéroport international de Kinshasa"
...
export default function HomePage() {
  return (
    <main className="overflow-hidden bg-dark-bg text-white">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
            <span className="text-yellow-400 font-semibold text-xs sm:text-sm uppercase tracking-wider">Réservez votre véhicule</span>
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-300 px-2">
              Sélectionnez vos lieux, dates et heures de prise en charge et de retour pour voir les véhicules disponibles.
            </p>
          </div>
      ...
      {/* Section statistiques - identique */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-gray-900 to-black text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
            backgroundImage: 'radial-gradient(circle at 2px 2px, #FDBB02 1px, transparent 0)',
      ...
      {/* Section véhicules vedettes - avec composant simple sans boutons */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16">
            <span className="text-yellow-400 font-semibold text-xs sm:text-sm uppercase tracking-wider">Notre flotte prestige</span>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              { name: 'Jean Dupont', date: '2025', text: 'Service impeccable ! Véhicule propre, chauffeur ponctuel et professionnel. Je recommande vivement.' },
              { name: 'Marie Atangana', date: '2026', text: 'Très satisfaite du service. La réservation via WhatsApp est super pratique et rapide.' },
              { name: 'Paul Nguema', date: '2025', text: 'Excellent rapport qualité-prix. Les véhicules sont modernes et bien entretenus. Je reviendrai !' }
            ].map((testimonial, index) => (
              <div key={index} className="bg-gray-900 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-800">
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-yellow-400/10 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold text-sm sm:text-base md:text-lg text-white">{testimonial.name}</h4>
                    <p className="text-xs sm:text-sm text-gray-400">Client depuis {testimonial.date}</p>
                  </div>
                </div>
                <p className="text-xs sm:text-sm md:text-base text-gray-300 italic">"{testimonial.text}"</p>
