...
import Image from 'next/image';
import { logoutAdmin } from '@/lib/actions';
import { FaTachometerAlt, FaHome, FaInfoCircle, FaEnvelope, FaSignOutAlt, FaWhatsapp } from 'react-icons/fa';
...
export default function AdminHeader() {
  ...
  // Navigation items - Updated for new structure
  const navItems = [
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-gray-900 to-black border-b border-yellow-400/20 shadow-lg">
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between h-36 md:h-24">
          
          {/* Logo */}
          <Link href="/admin/dashboard" className="flex items-center gap-3 group">
            <div className="relative w-36 h-36 md:w-10 md:h-10 overflow-hidden rounded-full">
              <Image
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-white leading-tight">Valmont</span>
              <span className="font-bold text-base md:text-lg text-yellow-400 leading-tight -mt-1">Car Rent</span>
              <span className="text-[10px] text-gray-400 -mt-0.5">Administration • Seychelles</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-green-600/20"
            >
            ...
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 bg-red-600/90 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-red-600/20 ml-2"
            >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              animate={{ opacity: 1, height: 'auto' }}
              exit={{ opacity: 0, height: 0 }}
              className="md:hidden bg-gray-800/95 backdrop-blur-sm shadow-xl rounded-lg mt-2 border border-yellow-400/20 overflow-hidden"
            >
              <div className="flex flex-col p-4 space-y-2">
                ...
                <div className="pt-3 mt-2 border-t border-gray-700 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-red-600/90 hover:bg-red-700 text-white py-3 rounded-lg transition font-semibold"
                  >
