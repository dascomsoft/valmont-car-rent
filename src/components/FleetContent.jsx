...
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         className="text-center py-12 sm:py-16 md:py-20 bg-gray-900/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl mx-4 sm:mx-0 border border-yellow-400/20"
//       >
//         <p className="text-xl sm:text-2xl text-gray-200">Aucun véhicule disponible pour le moment.</p>
//         <p className="text-sm sm:text-base text-gray-400 mt-2">Revenez bientôt ou contactez-nous directement.</p>
//         <Link
...
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-2 sm:px-0">
//         {filteredVehicles.map((vehicle, index) => (
//           <VehicleCard key={vehicle.id} vehicle={vehicle} index={index} selectedDate={selectedDate} />
//         ))}
//       </div>
...
// export default function FleetContent({ vehicles, unavailableMap, selectedDate: initialDate }) {
//   const [filter, setFilter] = useState('Tous');
...
//           const availability = unavailableMap.get(vehicle.id);
//           const isAvailable = !availability;
//           const reservationEndDate = availability?.return_date;
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-2 sm:px-0">
        {filteredVehicles.map((vehicle) => {
          ...
          const availability = unavailableMap?.get(vehicle.id);
          const isAvailable = !availability;
          const reservationEndDate = availability?.return_date || null;
